...
class Config(object):
    ...
    def __init__(self, dataset, pretrained_name_or_path=None):
        ...
        self.embed = 768  # 字向量维度，原实现为300
        self.dim_model = 768  # hidden size,原参数为300，一般设置为64*num_head
        self.hidden = 1024  # unsed
        self.last_hidden = 512  # unsed
        self.num_head = 12  # 原参数为5，一般取8,12,24
        self.num_encoder = 12  # 原参数为2，一般取12,24
